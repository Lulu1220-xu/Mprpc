...
class GetFriendListRespond;
class GetFriendListRespondDefaultTypeInternal;
extern GetFriendListRespondDefaultTypeInternal _GetFriendListRespond_default_instance_;
class ResultCode;
...
template<> ::fixbug::GetFriendListRespond* Arena::CreateMaybeMessage<::fixbug::GetFriendListRespond>(Arena*);
...
class GetFriendListRespond :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListRespond) */ {
 public:
  GetFriendListRespond();
  virtual ~GetFriendListRespond();

  GetFriendListRespond(const GetFriendListRespond& from);
  GetFriendListRespond(GetFriendListRespond&& from) noexcept
    : GetFriendListRespond() {
    *this = ::std::move(from);
  }

  inline GetFriendListRespond& operator=(const GetFriendListRespond& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListRespond& operator=(GetFriendListRespond&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListRespond& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListRespond* internal_default_instance() {
    return reinterpret_cast<const GetFriendListRespond*>(
               &_GetFriendListRespond_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetFriendListRespond& a, GetFriendListRespond& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListRespond* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListRespond* New() const final {
    return CreateMaybeMessage<GetFriendListRespond>(nullptr);
  }

  GetFriendListRespond* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListRespond>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListRespond& from);
  void MergeFrom(const GetFriendListRespond& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListRespond* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListRespond";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListRespond)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListRespond::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListRespond::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListRespond::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListRespond::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFriendListRespond::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRespond.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListRespond::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListRespond.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListRespond::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListRespond::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListRespond.result)
  return _internal_mutable_result();
}
inline void GetFriendListRespond::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListRespond.result)
}

// repeated bytes friends = 2;
inline int GetFriendListRespond::_internal_friends_size() const {
  return friends_.size();
}
inline int GetFriendListRespond::friends_size() const {
  return _internal_friends_size();
}
inline void GetFriendListRespond::clear_friends() {
  friends_.Clear();
}
inline std::string* GetFriendListRespond::add_friends() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListRespond.friends)
  return _internal_add_friends();
}
inline const std::string& GetFriendListRespond::_internal_friends(int index) const {
  return friends_.Get(index);
}
inline const std::string& GetFriendListRespond::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRespond.friends)
  return _internal_friends(index);
}
inline std::string* GetFriendListRespond::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListRespond.friends)
  return friends_.Mutable(index);
}
inline void GetFriendListRespond::set_friends(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRespond.friends)
  friends_.Mutable(index)->assign(value);
}
inline void GetFriendListRespond::set_friends(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRespond.friends)
  friends_.Mutable(index)->assign(std::move(value));
}
inline void GetFriendListRespond::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListRespond.friends)
}
inline void GetFriendListRespond::set_friends(int index, const void* value, size_t size) {
  friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListRespond.friends)
}
inline std::string* GetFriendListRespond::_internal_add_friends() {
  return friends_.Add();
}
inline void GetFriendListRespond::add_friends(const std::string& value) {
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListRespond.friends)
}
inline void GetFriendListRespond::add_friends(std::string&& value) {
  friends_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListRespond.friends)
}
inline void GetFriendListRespond::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListRespond.friends)
}
inline void GetFriendListRespond::add_friends(const void* value, size_t size) {
  friends_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListRespond.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendListRespond::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListRespond.friends)
  return friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendListRespond::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListRespond.friends)
  return &friends_;
}
