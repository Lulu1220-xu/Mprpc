...
class LoginResponse :
 ...
 public:
  ...
  // int32 sucess = 2;
  void clear_sucess();
  ::PROTOBUF_NAMESPACE_ID::int32 sucess() const;
  void set_sucess(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_sucess() const;
  void _internal_set_sucess(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 sucess_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_user_2eproto;
};
// -------------------------------------------------------------------
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResponse::_internal_sucess() const {
  return sucess_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResponse::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.sucess)
  return _internal_sucess();
}
inline void LoginResponse::_internal_set_sucess(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  sucess_ = value;
}
inline void LoginResponse::set_sucess(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RegisterResponse::_internal_sucess() const {
  return sucess_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RegisterResponse::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.sucess)
  return _internal_sucess();
}
inline void RegisterResponse::_internal_set_sucess(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  sucess_ = value;
}
inline void RegisterResponse::set_sucess(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_sucess(value);
