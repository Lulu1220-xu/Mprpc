...
class GetFriendListRespondDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListRespond> _instance;
...
static void InitDefaultsscc_info_GetFriendListRespond_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListRespond_default_instance_;
    new (ptr) ::fixbug::GetFriendListRespond();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListRespond::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendListRespond_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendListRespond_friend_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespond, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespond, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespond, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::ResultCode)},
  { 7, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 13, -1, sizeof(::fixbug::GetFriendListRespond)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListRespond_default_instance_),
};
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "equest\032\034.fixbug.GetFriendListRespondB\003\200\001"
  "\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_friend_2eproto_sccs[3] = {
  ...
  &scc_info_GetFriendListRespond_friend_2eproto.base,
  &scc_info_ResultCode_friend_2eproto.base,
};
...
void GetFriendListRespond::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListRespond_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListRespond::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListRespond* msg);
};

const ::fixbug::ResultCode&
GetFriendListRespond::_Internal::result(const GetFriendListRespond* msg) {
  return *msg->result_;
}
GetFriendListRespond::GetFriendListRespond()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListRespond)
}
GetFriendListRespond::GetFriendListRespond(const GetFriendListRespond& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListRespond)
}

void GetFriendListRespond::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListRespond_friend_2eproto.base);
  result_ = nullptr;
}

GetFriendListRespond::~GetFriendListRespond() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListRespond)
  SharedDtor();
}

void GetFriendListRespond::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListRespond::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListRespond& GetFriendListRespond::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRespond_friend_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListRespond::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListRespond)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListRespond::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListRespond::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListRespond)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListRespond)
  return target;
}

size_t GetFriendListRespond::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListRespond)
  size_t total_size = 0;
...
void GetFriendListRespond::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListRespond)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListRespond* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListRespond>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListRespond)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListRespond)
    MergeFrom(*source);
  }
}

void GetFriendListRespond::MergeFrom(const GetFriendListRespond& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListRespond)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListRespond::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListRespond)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListRespond::CopyFrom(const GetFriendListRespond& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListRespond)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListRespond::IsInitialized() const {
  return true;
}

void GetFriendListRespond::InternalSwap(GetFriendListRespond* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListRespond::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 0:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListRespond*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendListRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFriendListRespond::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListRespond* Arena::CreateMaybeMessage< ::fixbug::GetFriendListRespond >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListRespond >(arena);
}
