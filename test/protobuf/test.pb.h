...
class GetFriendListsRequest :
 ...
 public:
  ...
  // int32 usrid = 1;
  void clear_usrid();
  ::PROTOBUF_NAMESPACE_ID::int32 usrid() const;
  void set_usrid(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_usrid() const;
  void _internal_set_usrid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::int32 usrid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
// -------------------------------------------------------------------
...
// int32 usrid = 1;
inline void GetFriendListsRequest::clear_usrid() {
  usrid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendListsRequest::_internal_usrid() const {
  return usrid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendListsRequest::usrid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRequest.usrid)
  return _internal_usrid();
}
inline void GetFriendListsRequest::_internal_set_usrid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  usrid_ = value;
}
inline void GetFriendListsRequest::set_usrid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_usrid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsRequest.usrid)
}
